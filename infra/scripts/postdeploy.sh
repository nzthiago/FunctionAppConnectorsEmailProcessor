...
echo -e "${YELLOW}║  6. Go to Connections → authorize the MS Graph (Groups & Users)      ║${NC}"
echo -e "${YELLOW}║     connection (used to enrich Teams notifications with sender info)  ║${NC}"
echo -e "${YELLOW}║                                                                      ║${NC}"
